...
export default function Hero() {
    const { data: _projects } = swr('https://ardaabi1.github.io/projects/list.json', 3000);
            ...
            <div className="flex items-center">
                <div className="text-center sm:text-right w-full">
                    <div className="pb-1 flex items-center justify-center sm:justify-end">
                        ...
                        <h1 className="leading-none text-white font-bold text-4xl">oradaki,</h1>
                    </div>
                    <h1 className="leading-none text-white font-bold text-4xl">Ben Arda.</h1>
                    <p className="pt-3 w-4/5 lg:w-8/12 mx-auto sm:mr-0 sm:ml-auto text-gray-400">Tam Yığın Geliştirici. Türkiye'de yaşıyorum. Lise öğrencisiyim ve kendini geliştiren biriyim.</p>
                </div>
            </div>
                ...
                <div className={(!projects || !randomOne ? "animate-pulse" : "") + " w-32 h-16 absolute top-[10%] left-[20%] sm:left-[10%] project-box tone-1 p-3 rounded-lg perspective-left flex items-center space-x-2"}>
                    {randomOne ? <>
                        ...
                        <div className="space-y-1">
                            ...
                            <a href={randomOne.link} target="_blank" className="hover:underline font-light text-[0.75rem] text-zinc-200 leading-none"><i className="fal fa-arrow-up-right-from-square mr-1" /> Ziyaret</a>
                        </div>
                    </> : <>
                ...
                <div className={(!projects || !randomTwo ? "animate-pulse" : "") + " w-32 h-16 absolute top-[60%] left-[10%] sm:left-[0%] project-box tone-2 p-3 rounded-lg perspective-right flex items-center space-x-2"}>
                    {randomTwo ? <>
                        ...
                        <div className="space-y-1">
                            ...
                            <a href={randomTwo.link} target="_blank" className="hover:underline font-light text-[0.75rem] text-zinc-200 leading-none"><i className="fal fa-arrow-up-right-from-square mr-1" />Ziyaret</a>
                        </div>
                    </> : <>
                        <div className="w-8 h-8 rounded-lg bg-white/10" />
                        <div className="space-y-1">
                ...
                <div className={(!projects || !randomThree ? "animate-pulse" : "") + " w-32 h-16 absolute top-[35%] left-[50%] sm:left-[40%] project-box tone-3 p-3 rounded-lg perspective-middle flex items-center space-x-2"}>
                    {randomThree ? <>
                        ...
                        <div className="space-y-1">
                            ...
                            <a href={randomThree.link} target="_blank" className="hover:underline font-light text-[0.75rem] text-zinc-200 leading-none"><i className="fal fa-arrow-up-right-from-square mr-1" /> Ziyaret</a>
                        </div>
                    </> : <>
                        <div className="w-8 h-8 rounded-lg bg-white/10" />
                        <div className="space-y-1">
