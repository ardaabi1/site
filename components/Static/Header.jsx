        ...
        <>
            <div className={"pb-10 w-full flex items-center justify-between"}>
                <div className="flex items-center space-x-2">
                    <Link href="/">
                        <a className="pr-1 text-white font-bold text-4xl">Ardaaa</a>
                    </Link>
                    ...
                    <a target="_blank" href="https://twitter.com/ardaa_mvr" className="flex items-center justify-center cursor-pointer social w-10 h-10 rounded-lg">
                        <i className="fab fa-instagram" />
                    </a>
                    <a target="_blank" href="https://github.com/ardaabi1" className="flex items-center justify-center cursor-pointer social w-10 h-10 rounded-lg">
                        ...
                        <li>
                            <Link href="/">
                                <a className={`flex items-center ${router.route == '/' ? 'text-gray-100 font-semibold' : 'hover:text-white transition-all'}`}>
                                    <UilEstate /> <h6 className="ml-1">Ana Sayfa</h6>
                                </a>
                            </Link>
                        </li>
                        <li>
                            <Link href="/about">
                                <a className={`flex items-center ${router.route == '/about' ? 'text-gray-100 font-semibold' : 'hover:text-white transition-all'}`}>
                                    <UilUser /> <h6 className="ml-1">Hakkımda</h6>
                                </a>
                            </Link>
                        </li>
                        <li>
                            <Link href="/projects">
                                <a className={`flex items-center ${router.route == '/projects' ? 'text-gray-100 font-semibold' : 'hover:text-white transition-all'}`}>
                                    <UilBox /> <h6 className="ml-1">Projelerim</h6>
                                </a>
                            </Link>
                        </li>
                        <li>
                            <Link href="/contact">
                                <a className={`flex items-center ${router.route == '/contact' ? 'text-gray-100 font-semibold' : 'hover:text-white transition-all'}`}>
                                    <UilEnvelope /> <h6 className="ml-1">İletişim</h6>
                                </a>
                            </Link>
                        </li>
                    </ul>
